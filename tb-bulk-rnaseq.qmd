...
## Overview
Bulk RNA‑seq analysis of tuberculosis cohort GSE107994.
...
write_tsv(phenotypes_slim, file = file.path("data_processed", "phenotypes.tsv"))
```

{{< pagebreak >}}

## Analysis 1
(Active TB vs LTBI vs LTBI progressor vs Control. Baseline samples. No outliers. Both sexes)
(look for enrichment of type I IFN‑inducible genes)
...
save_plot(
  filename = file.path("plots", "analysis1_pca.png"),
  plot = pca_plot,
  bg = "white"
)
